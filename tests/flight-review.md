...
7. Hide the tab; rendering stops but audio remains running across phrase boundaries. Return; visuals resume without a time jump. An explicitly paused journey remains paused, with audio suspended.
